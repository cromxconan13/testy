class Translation(object):
    START_TEXT = """Привет, 
я помощник, который скачивает любые видео из интернета!

<b>Отправь мне в чат ссылку на видео или музыку, а готовый файл, я отправлю с этот чат</b>

/help for more details..

Support Group : @neverm1nda"""
